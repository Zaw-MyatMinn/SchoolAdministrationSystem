...
<body>
	<nav class="navbar navbar-expand-sm bg-light navBg">
		...
		<ul class="navbar-nav">
			<li class="nav-item menuFont"><a class="nav-link menuFont"
				href="listGrade">Grade</a></li>
			<li class="nav-item menuFont"><a class="nav-link menuFont"
				href="listClass">Class</a></li>
			<li class="nav-item menuFont"><a class="nav-link menuFont"
				href="listStudent">Student Registration</a></li>
			<li class="nav-item menuFont"><a class="nav-link menuFont"
				href="listPayment">Student Academic</a></li>
			<li class="nav-item menuFont"><a class="nav-link menuFont"
				href="listHistory">Student Academic History</a></li>
